        ...
        <table class="form_table">
            <thead class="form_head">
                <tr class="form_head_tr mx-auto">
                    <th class="text-center selectof1 Contrat choice data" style="width:90px;padding:10px;">Contrat<br><input class="filter"  style="width:80%;" placeholder="N°" data-col="Contrat"></th>
                    <th class="text-center selectof2 Devis choice" style="width:90px;padding:10px;">N° devis<br><input class="filter"  style="width:96%;" placeholder="N°" data-col="N° devis"></th>
                    <th class="text-center selectof3 CMD" style="width:60px;padding:10px;">N° CMD <br><input class="filter"  style="width:50%;" placeholder="N°" data-col="N° CMD"></th>
                    <th class="text-center BDC padding_non_input">BDC <br>decima</th>
                    <th class="text-center DateReceptionCDE">Date <br>reception CDE<br><!--<input type="text" class="input_text_thead filter">--></th>
                    <th class="text-center Libelle libelle_box" style="width:200px!important;;padding:10px;">Libellé <br><input class="filter"  style="width:50%;" placeholder="Libellé" data-col="Libellé"></th>
                    <th class="text-center MontantDecima padding_non_input" style="width:80px;">Montant Decima</th>
                    <th class="text-center NFacturationDecima" style="width:80px;">N°Facturation Decima<br><input class="filter"  style="width:60%;" placeholder="N°" data-col="N°Facturation Decima"></th>
                    ...
                    <th class="text-center EtatFacturation padding_non_input">Etat<br></th>
                    ...
                    <th class="text-center DevisST" style="width:80px;">N° devis <br>ST<br><input class="filter"  style="width:80%;" placeholder="N°" data-col="N° devis ST"></th>
                    <th class="text-center MontantST padding_non_input" style="width:80px;">Montant <br>ST</th>
                    <th class="text-center NFactureST">N° facture ST<br><input class="filter"  style="width:60px;" placeholder="N°" data-col="N° facture ST"></th>
                    ...
                    <th class="text-center InfoEquipement(UBE)">Info equipement </th>
                    ...
                    <tr class="form_body_tr" style="background-color:<?=$color?>;">
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-sm-6" style="width:110px;">
                                        <input type="text" class="date_commande_tab_<?=$d['id_devis']?> form-control datepicker" name="date_commande_tab_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_commande'])?>">
                                    </div>
                                </div>
                            </div>
                        </td>                                  
                        ...
                        <td class="DateFacturation">
                            <div>
                                <div class="row">
                                    <div class="col-sm-6" style="width:110px;">
                                        <input type="text" class="date_facture_decima_tab_<?=$d['id_devis']?> form-control datepicker" name="date_facture_decima_tab_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_facture'])?>">
                                    </div>
                                </div>
                            </div>
                        </td>             
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-sm-6" style="width:110px;margin-left:5px;">
                                        <input type="text" class="date_facturation_4_tab_<?=$d['id_devis']?> form-control datepicker" name="date_facturation_4_tab_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_facturation_4'])?>">
                                    </div>
                                </div>
                            </div>
                        </td>                                  
                        ...
                        <td style="width:100px">
                            <div>
                                <div class="row">
                                    <div class="col-sm-6" style="width:110px;">
                                        <input type="text" class="date_facturation_st_tab_<?=$d['id_devis']?> form-control datepicker" name="date_facturation_st_tab_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_facturation_st'])?>">
                                    </div>
                                </div>
                            </div>
                        </td>                                  
                        ...
                        <td style="width:100px">
                            <div>
                                <div class="row">
                                    <div class="col-sm-6" style="width:110px;">
                                        <input type="text" class="date_reception_tab_<?=$d['id_devis']?> form-control datepicker" name="date_reception_tab_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_reception'])?>">
                                    </div>
                                </div>
                            </div>
                        </td>                                  
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="taille_date_modification">
                                                            <input type="text" class="date_commande_<?=$d['id_devis']?> form-control datepicker" name="date_commande_2<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_commande'])?>">
                                                        </div>
                                                    </div>    
                                                </div>
                                            </div>
                                            <div class="modal_couleur">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="taille_date_modification">
                                                            <input type="text" class="date_facture_decima_<?=$d['id_devis']?> form-control datepicker" name="date_facture_decima_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_facture'])?>">
                                                        </div>
                                                    </div> 
                                                    <div>
                                                        <p style="margin-left:60px;">Date facturation 4%</p>
                                                        <div class="taille_date_modification">
                                                            <input type="text" class="date_facturation_4_<?=$d['id_devis']?> form-control datepicker" name="date_facturation_4_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_facturation_4'])?>">
                                                        </div>
                                                    </div> 
                                                </div>
                                            </div>
                                            <div class="modal_couleur">
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        <p style="margin-left:60px;">Date facturation</p>
                                                        <div class="taille_date_modification">
                                                            <input type="text" class="date_facturation_st_<?=$d['id_devis']?> form-control datepicker" name="date_facturation_st_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_facturation_st'])?>">
                                                        </div>
                                                    </div>     
                                                </div>
                                            </div>
                                            <div class="modal_couleur">
                                                ...
                                                <div class="taille_date_modification">
                                                    <input type="text" class="date_reception_<?=$d['id_devis']?> form-control datepicker" name="date_reception_<?=$d['id_devis']?>" placeholder="<?=date('d/m/y', $d['date_reception'])?>">
                                                </div>
