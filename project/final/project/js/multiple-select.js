...
(function ($) {
        ...
        optionToHtml: function (i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                var value = $elm.val(),
                    ...
                    style = sprintf('style="%s"', (group ? 'margin: 0px 20px;' : '') + this.options.styler(value)),
                    $el;
                ...
                $el = $([
                    ...
                    sprintf('<span class="ms-default-item">%s</span>', text),
                    '</label>',
                    '</li>'
                ].join(''));
    ...
    $.fn.multipleSelect.defaults = {
        ...
        formatSelectAll: function () {
            return '[Tout sélectionner/désélectionner]';
        },
        formatAllSelected: function () {
            return 'Tout est sélectionné';
        },
