    ...
    var r = n(0)
      ...
      , c = function() {
        ...
        return e.callDbDroppedByBrowser = function(t) {
            e.dbStatus.conStatus === r.b.Connected && (e.isDbDeletedByBrowser = !0,
            !0 === t && new i.a(function() {}
            ,function() {}
            ).deleteMetaData())
        }
        ,
...
, , function(e, t, n) {
      ...
      , s = function() {
        ...
        return e.prototype.check = function(e, t) {
            ...
            return typeof e === r.c.Object ? this.table ? this.table.columns.every(function(t) {
                return null === o && (t.name in e && (o = n.checkByColumn_(t, e[t.name])),
                !0)
        ...
        e.prototype.checkByColumn_ = function(e, t) {
            ...
            s && "object" === o)
                for (var a = ["+", "-", "*", "/"], h = 0, l = Object.keys(t); h < l.length; h++) {
                    var f = l[h];
      ...
      , a = function() {
        ...
        return e.prototype.checkAndModifyValue = function(e) {
            ...
            this.table.columns.every(function(e) {
                return t.checkAndModifyColumnValue_(e),
                !t.errorOccured
            }),
            this.errorOccured
        }
        ...
        e.prototype.checkAndModifyColumnValue_ = function(e) {
            ...
            e.autoIncrement ? u(t) ? this.value[e.name] = ++this.autoIncrementValue[e.name] : Object(c.a)(t) === r.c.Number && t > this.autoIncrementValue[e.name] && (this.autoIncrementValue[e.name] = t) : e.default && u(t) && (this.value[e.name] = e.default),
            this.checkNotNullAndDataType_(e)
        }
        ,
        e.prototype.onValidationError_ = function(e, t) {
            this.errorOccured = !0,
            this.log = new i.a(e,t)
        }
        ,
        e
    }()
    ...
    var _ = function() {
        ...
        e.prototype.isInsertQryValid_ = function(e) {
            var t, n = this.getTable_(this.query.into);
            if (n)
        ...
        e.prototype.checkInsertQuery_ = function() {
            var e = this;
            return Object(h.a)(function(t, n) {
                var r, o = e.isInsertQryValid_(function(e) {
                    r = e
                });
                if (null == o)
                    if (!0 === e.query.skipDataCheck)
                        t();
                    else {
                        var i = new p(r,e.query.values);
                        i.checkAndModifyValues().then(function() {
                            e.query.values = i.values,
                            t()
                        }).catch(n)
                    }
                else
        ...
        e.prototype.checkUpdateQuery_ = function() {
            this.error = new s(this.getTable_(this.query.in)).check(this.query.set, this.query.in),
            null == this.error && null != this.query.where && (this.checkForNullInWhere_(),
        ...
        e.prototype.checkForNullInWhere_ = function() {
            for (var e in this.query.where)
                if (null == this.query.where[e])
                    return void (this.error = new i.a(r.d.NullValueInWhere,{
                        column: e
                    }).get())
        }
        ,
        e.prototype.checkFetchQuery_ = function() {
            !0 === this.isTableExist_(this.query.from) ? null != this.query.where && (this.checkForNullInWhere_(),
            null == this.error && this.addGreatAndLessToNotOp_()) : this.error = new i.a(r.d.TableNotExist,{
            ...
            var e = this.query.where
              ...
              , n = function(e, t) {
                ...
                return t.forEach(function(t) {
                    null != (n = e[t])[r.g.NotEqualTo] && (e[t][r.g.GreaterThan] = n[r.g.NotEqualTo],
                    void 0 === e[r.g.Or] ? (e[r.g.Or] = {},
                    e[r.g.Or][t] = {}) : void 0 === e[r.g.Or][t] && (e[r.g.Or][t] = {}),
                    e[r.g.Or][t][r.g.LessThan] = n[r.g.NotEqualTo],
    ...
    var r = n(2)
      ...
      , u = function() {
        ...
        e.prototype.checkLike = function(e, t) {
            var n, r, i, u = this.where[e][o.g.Like].split("%");
            switch (u[1] ? (r = u[1],
            n = u.length > 2 ? o.f.Any : o.f.Last) : (r = u[0],
            n = o.f.First),
            t = t.toLowerCase(),
            n) {
            case o.f.Any:
    ...
    function(e, t) {
        ...
        t.prototype.onErrorOccured = function(e, t) {
            ...
            t)
                ...
                var n = void 0;
                e.name ? (n = new c.a(e.name)).message = e.message : (n = new c.a(e.target.error.name)).message = e.target.error.message,
                this.error = n.get()
            }
        }
        ,
        ...
        t.prototype.getRegexFromLikeExpression_ = function(e) {
            var t, n, r = e.split("%");
            switch (r[1] ? (t = r[1],
            n = r.length > 2 ? o.f.Any : o.f.Last) : (t = r[0],
            n = o.f.First),
            n) {
            case o.f.First:
        ...
        t.prototype.goToWhereLogic = function() {
            ...
            if (!0 === this.query.ignoreCase && (this.query.where = this.makeQryInCaseSensitive(this.query.where)),
            this.objectStore.indexNames.contains(e)) {
        ...
        t.prototype.makeQryInCaseSensitive = function(e) {
            ...
            for (var i in e)
                ...
                Object(a.a)(t)) {
                case o.c.String:
                    r = r.concat(this.getAllCombinationOfWord(t)),
                    e[i] = {},
                    e[i][o.g.In] = r;
                    break;
                case o.c.Object:
...
, function(e, t, n) {
    ...
    var o, i = function() {
        ...
        return e.prototype.onErrorOccured = function(e) {
            ++this.errorCount,
            1 === this.errorCount && null != this.onError && this.onError(e.target.error),
            console.error(e)
        }
        ,
        e
        ...
        e.createTransaction = function(t, n, r) {
            null === e.transaction && (r = r || "readwrite",
    ...
    function(e, t) {
        ...
        t.prototype.execute = function() {
            ...
            var t, n, r;
            this.errorOccured || (t = g.columnName,
            n = this.key,
        ...
        t.prototype.initTransaction = function() {
            u.createTransaction([g.tableName], this.onTransactionCompleted.bind(this)),
            this.objectStore = u.transaction.objectStore(g.tableName)
        }
        ,
        ...
        t.prototype.execute = function() {
            ...
            this.initTransaction(),
            (e = t.objectStore.index(g.columnName).openCursor(IDBKeyRange.only(t.query[g.columnName]))).onsuccess = function(e) {
        ...
        ,
        t.prototype.initTransaction = function() {
            u.createTransaction([g.tableName], this.onTransactionCompleted_),
            this.objectStore = u.transaction.objectStore(g.tableName)
        }
        ,
        t
        ...
        return function(e, t, n) {
            ...
            o.onsuccess = function(e) {
                ...
                u.dbConnection.onclose = function() {
                    ...
                    f.updateDbStatus(r.Closed, l.d.ConnectionClosed)
                }
                ,
                u.dbConnection.onversionchange = function(e) {
                    null === e.newVersion && (e.target.close(),
                    u.callDbDroppedByBrowser(),
                    f.updateDbStatus(r.Closed, l.d.ConnectionClosed))
                }
                ,
        ...
        t.prototype.initTransaction_ = function() {
            u.createTransaction([g.tableName], this.onTransactionCompleted_, "readonly"),
            this.objectStore = u.transaction.objectStore(g.tableName)
        }
        ,
        t
        ...
        e.prototype.closeDb = function(e, t) {
            u.dbStatus.conStatus === r.Connected && (u.dbStatus.conStatus = r.Closed,
        ...
        e.onQueryFinished = function(e) {
            ...
            e.errorOccured ? t.onError(e.errorDetails) : t.onSuccess(e.returnedValue),
            this.executeCode()
        }
        ,
        e.requestQueue = [],
...
, function(e, t, n) {
    ...
    var r = function() {
        function e() {}
        return e.isLogEnabled = !1,
        e.isRuningInWorker = !1,
        e
    }()
}
, function(e, t, n) {
    "use strict";
    var r, o = n(4), i = n(6), u = n(7), c = (r = function(e, t) {
    ...
    function(e, t) {
        ...
        ,
        t
    }(i.a), f = n(2), p = n(19), _ = n(16), y = n(12), d = function() {
        var e = function(t, n) {
            return (e = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
        ...
        t.prototype.execute = function(e) {
            ...
            r.onsuccess = function(e) {
                t.dbStatus.conStatus = a.b.Connected,
                ...
                o ? t.savedbNameIntoDbList_().then(function() {
            ...
            r.onupgradeneeded = function(r) {
                ...
                var i = r.target.result
                  , c = function(e, r) {
                    try {
                        var o;
                        e.primaryKey.length > 0 ? (t.activeDb.tables[r].primaryKey = e.primaryKey,
                        ...
                        e.columns.forEach(function(n) {
                            if (!0 === n.enableSearch) {
                                ...
                                o.createIndex(n.name, i, r),
                                n.autoIncrement && u.a.set("JsStore_" + t.dbName + "_" + e.name + "_" + n.name + "_Value", 0)
                            }
                        }),
                        n.push(e.name),
                        u.a.set("JsStore_" + t.dbName + "_" + e.name + "_Version", e.version)
                    } catch (e) {
                        console.error(e)
                    }
                };
                e.forEach(function(e, t) {
                    e.requireDelete ? (i.objectStoreNames.contains(e.name) && i.deleteObjectStore(e.name),
                    c(e, t)) : e.requireCreation && c(e, t)
                })
            }
        }
        ,
        t.prototype.savedbNameIntoDbList_ = function() {
            ...
            return Object(y.a)(function(t, n) {
                e.getDbList().then(function(r) {
                    r.indexOf(e.dbName) < 0 ? (r.push(e.dbName),
                    e.setDbList(r).then(t).catch(n)) : t()
                }).catch(n)
            })
        }
        ,
        t.prototype.setPrimaryKey_ = function() {
            ...
            this.activeDb.tables.forEach(function(t, n) {
                t.columns.every(function(t) {
                    return e.activeDb.tables[n].primaryKey = t.primaryKey ? t.name : "",
                    !t.primaryKey
                })
            })
        }
        ,
        t
    }(_.a), g = n(25), v = n(28), m = n(24), O = n(27), D = n(26), x = n(35), w = n(1), E = n(8), k = function() {
        function e(e) {
            this.columns = [],
        ...
        e.prototype.setPrimaryKey_ = function() {
            ...
            this.columns.every(function(t) {
                return e.primaryKey = t.primaryKey ? t.name : "",
                !t.primaryKey
            })
        }
        ,
        ...
        e.prototype.setDbVersion_ = function(e) {
            var t = this;
            f.a.activeDbVersion = f.a.activeDbVersion > this.version ? f.a.activeDbVersion : this.version,
            u.a.set("JsStore_" + e + "_Db_Version", f.a.activeDbVersion),
            u.a.set("JsStore_" + e + "_" + this.name + "_Version", f.a.activeDbVersion).then(function() {
                t.version = f.a.activeDbVersion,
                t.callback_(t)
            })
        }
        ,
    ...
    var P = function() {
        function e(e) {
            this.onQueryFinished = e,
            o.a.autoIncrementValues = {}
        }
        return e.prototype.checkConnectionAndExecuteLogic = function(e) {
            var t = this;
            switch (w.a.log("request executing:" + e.name),
            e.name) {
            case a.a.InitDb:
            case a.a.IsDbExist:
        ...
        e.prototype.executeLogic_ = function(t) {
            ...
            switch (e.isTransactionQuery = t.name === a.a.Transaction,
            t.name) {
            case a.a.InitDb:
                !0 === this.isDbDeletedByBrowser_ ? this.initDb_(null, function() {
        ...
        e.prototype.closeDb_ = function() {
            f.a.dbStatus.conStatus === a.b.Connected && (f.a.dbStatus.conStatus = a.b.ClosedByJsStore,
            f.a.dbConnection.close())
        }
        ,
        e.prototype.dropDb_ = function(e, t) {
            this.closeDb_(),
            new p.a(e,t).deleteDb()
        }
        ,
        e.prototype.processCreateDb = function(e) {
            ...
            return Object(y.a)(function(n, r) {
                new q(e).createMetaData().then(function(o) {
                    ...
                    new b(function(r) {
                        t.activeDb_ = e,
                        u.a.set("JsStore_" + e.name + "_Schema", e),
                        n(r)
                    }
                    ,r).execute(o)
                })
        ...
        e.prototype.initDb_ = function(e, t, n) {
            var r = this;
            null == e ? this.processCreateDb(this.activeDb_) : (this.closeDb_(),
            this.getDbVersion_(e.name).then(function(o) {
                r.activeDbVersion_ = o || 1,
                r.processCreateDb(new T(e)).then(t).catch(n)
            }).catch(n))
        }
        ,
    ...
    var r = n(2)
      ...
      , i = function() {
        ...
        e.prototype.onDbClose = function(e) {
            ...
            this.updateDbStatus(o.b.Closed, o.d.ConnectionClosed)
        }
        ,
...
, , , function(e, t, n) {
    ...
    var r, o = n(7), i = n(0), u = n(1), c = n(16), s = n(12), a = (r = function(e, t) {
        return (r = Object.setPrototypeOf || {
            __proto__: []
        }instanceof Array && function(e, t) {
            e.__proto__ = t
    ...
    function(e, t) {
        ...
        t.prototype.deleteMetaData = function() {
            ...
            return Object(s.a)(function(t, n) {
                o.a.remove("JsStore_" + e.dbName + "_Db_Version"),
                e.activeDb.tables.forEach(function(t) {
                    o.a.remove("JsStore_" + e.dbName + "_" + t.name + "_Version"),
            ...
            setTimeout(function() {
                ...
                t.onsuccess = function() {
                    e.deleteMetaData().then(function() {
                        e.onSuccess_(),
                        e.dbStatus.conStatus = i.b.Closed
                    }).catch(e.onError_)
                }
            }, 100)
        }
...
, , , function(e, t, n) {
    ...
    var r = n(9)
      ...
      , u = n(0)
      , c = function() {
        void 0 === self.alert && "undefined" == typeof ServiceWorkerGlobalScope && (o.a.isRuningInWorker = !0,
    ...
    !function() {
        try {
            ...
            indexedDB ? (IDBTransaction = IDBTransaction || self.webkitIDBTransaction || self.msIDBTransaction,
            self.IDBKeyRange = self.IDBKeyRange || self.webkitIDBKeyRange || self.msIDBKeyRange) : s()
        } catch (e) {
            s()
        }
    }(),
      ...
      , h = function(e, t) {
        ...
        return Object(c.a)(n.map(function(n) {
            var u = "JsStore_" + r.a.activeDb.name + "_" + e.name + "_" + n + "_Value"
              , c = t[n];
            return !0 === s.a.isTransactionQuery && (o.a.autoIncrementValues[e.name][n] = c),
            i.a.set(u, c)
        }))
    }
}
, function(e, t, n) {
    ...
    var r, o = n(6), i = n(13), u = n(12), c = n(4), s = n(0), a = (r = function(e, t) {
        return (r = Object.setPrototypeOf || {
            __proto__: []
        }instanceof Array && function(e, t) {
            e.__proto__ = t
    ...
    function(e, t) {
        ...
        t.prototype.insertData_ = function(e) {
            var t, n, r = this, o = !0 === this.query.upsert ? "put" : "add";
            ...
            t = this.transaction.objectStore(this.query.into),
            Object(i.a)(e.map(function(e) {
...
, function(e, t, n) {
    "use strict";
    var r, o, i, u, c, s, a, h, l, f, p, _ = n(0), y = n(11), d = (r = function(e, t) {
        return (r = Object.setPrototypeOf || {
            __proto__: []
        }instanceof Array && function(e, t) {
            e.__proto__ = t
    ...
    function(e, t) {
        ...
        t.prototype.executeWhereUndefinedLogic = function() {
            if (this.query.order && this.query.order.by && !1 !== this.query.order.idbSorting) {
                ...
                this.sorted = !0,
                this.cursorOpenRequest = this.objectStore.index(this.query.order.by).openCursor(null, t)
            } else
                this.cursorOpenRequest = this.objectStore.openCursor();
            this.cursorOpenRequest.onerror = this.onErrorOccured,
            !1 === this.isOrderWithLimit ? this.skipRecord && this.limitRecord ? this.executeSkipAndLimitForNoWhere_() : this.skipRecord ? this.executeSkipForNoWhere_() : this.limitRecord ? this.executeLimitForNotWhere_() : this.executeSimpleForNotWhere_() : this.skipRecord ? this.executeSkipForNoWhere_() : this.executeSimpleForNotWhere_()
        }
        ,
        t.prototype.executeSkipAndLimitForNoWhere_ = function() {
            var e, t = this, n = !1;
            this.cursorOpenRequest.onsuccess = function(r) {
                (e = r.target.result) ? n && t.results.length !== t.limitRecord ? (t.results.push(e.value),
                e.continue()) : (n = !0,
                e.advance(t.skipRecord)) : t.onQueryFinished()
            }
        }
        ,
        t.prototype.executeSkipForNoWhere_ = function() {
            var e, t = this, n = !1;
            this.cursorOpenRequest.onsuccess = function(r) {
                (e = r.target.result) ? n ? (t.results.push(e.value),
                e.continue()) : (n = !0,
                e.advance(t.skipRecord)) : t.onQueryFinished()
            }
        }
        ...
        t.prototype.executeSimpleForNotWhere_ = function() {
            ...
            this.cursorOpenRequest.onsuccess = function(t) {
                (e = t.target.result) ? (this.results.push(e.value),
                e.continue()) : this.onQueryFinished()
            }
            .bind(this)
        }
        ,
        t.prototype.executeLimitForNotWhere_ = function() {
            ...
            this.cursorOpenRequest.onsuccess = function(n) {
                (e = n.target.result) && t.results.length !== t.limitRecord ? (t.results.push(e.value),
                e.continue()) : t.onQueryFinished()
            }
        }
        ,
        t
    }(b), O = n(12), D = n(13), x = function() {
        var e = function(t, n) {
            return (e = Object.setPrototypeOf || {
                __proto__: []
            }instanceof Array && function(e, t) {
        ...
        t.prototype.executeSkipAndLimitForIn_ = function(e, t) {
            var n, r = this, u = this.objectStore.index(e);
            Object(D.a)(t.map(function(e) {
                return t = e,
                Object(O.a)(function(e, s) {
                    (n = u.openCursor(r.getKeyRange(t))).onsuccess = function(t) {
                        c = t.target.result,
                        r.results.length !== r.limitRecord && c ? (o() && i(c.value),
                        c.continue()) : e()
                    }
                    ,
                    n.onerror = s
        ...
        t.prototype.executeLimitForIn_ = function(e, t) {
            var n, r = this, i = this.objectStore.index(e);
            Object(D.a)(t.map(function(e) {
                return t = e,
                Object(O.a)(function(e, u) {
                    (n = i.openCursor(r.getKeyRange(t))).onsuccess = function(t) {
                        (c = t.target.result) && r.results.length !== r.limitRecord ? (o() && r.results.push(c.value),
                        c.continue()) : e()
                    }
                    ,
                    n.onerror = u
        ...
        t.prototype.executeSimpleForIn_ = function(e, t) {
            ...
            Object(D.a)(t.map(function(e) {
                ...
                Object(O.a)(function(e, u) {
                    (n = i.openCursor(r.getKeyRange(t))).onsuccess = function(t) {
                        (c = t.target.result) ? (o() && r.results.push(c.value),
                        c.continue()) : e()
                    }
                    ,
                    n.onerror = u
        ...
        t.prototype.executeRegexLogic = function(e, t) {
            ...
            this.cursorOpenRequest.onerror = this.onErrorOccured,
            this.skipRecord && this.limitRecord ? this.executeSkipAndLimitForRegex_() : this.skipRecord ? this.executeSkipForRegex_() : this.limitRecord ? this.executeLimitForRegex_() : this.executeSimpleForRegex_()
        }
        ,
        t.prototype.executeSkipAndLimitForRegex_ = function() {
            ...
            this.cursorOpenRequest.onsuccess = function(t) {
                l = t.target.result,
                e.results.length !== e.limitRecord && l ? (s() && a(l.value),
                l.continue()) : e.onQueryFinished()
            }
        }
        ,
        ...
        t.prototype.executeLimitForRegex_ = function() {
            ...
            this.cursorOpenRequest.onsuccess = function(t) {
                l = t.target.result,
                e.results.length !== e.limitRecord && l ? (s() && e.results.push(l.value),
                l.continue()) : e.onQueryFinished()
            }
        }
        ,
        t.prototype.executeSimpleForRegex_ = function() {
            var e = this;
            this.cursorOpenRequest.onsuccess = function(t) {
                (l = t.target.result) ? (s() && e.results.push(l.value),
                l.continue()) : e.onQueryFinished()
            }
        }
        ,
        ...
        t.prototype.executeWhereLogic = function(e, t, n, r) {
            ...
            ,
            t = n ? t[n] : t,
            this.cursorOpenRequest = this.objectStore.index(e).openCursor(this.getKeyRange(t, n), r),
            this.cursorOpenRequest.onerror = this.onErrorOccured,
            !1 === this.isOrderWithLimit ? this.skipRecord && this.limitRecord ? this.executeSkipAndLimitForWhere_() : this.skipRecord ? this.executeSkipForWhere_() : this.limitRecord ? this.executeLimitForWhere_() : this.executeSimpleForWhere_() : this.skipRecord ? this.executeSkipForWhere_() : this.executeSimpleForWhere_()
        }
        ,
        t.prototype.executeSkipAndLimitForWhere_ = function() {
            var e = this
              , t = !1;
            this.cursorOpenRequest.onsuccess = function(n) {
                (p = n.target.result) ? t && e.results.length !== e.limitRecord ? (f() && e.results.push(p.value),
                p.continue()) : (t = !0,
                p.advance(e.skipRecord)) : e.onQueryFinished()
            }
        }
        ,
        t.prototype.executeSkipForWhere_ = function() {
            var e = this
              , t = !1;
            this.cursorOpenRequest.onsuccess = function(n) {
                (p = n.target.result) ? t ? (f() && e.results.push(p.value),
                p.continue()) : (t = !0,
                p.advance(e.skipRecord)) : e.onQueryFinished()
            }
        }
        ...
        t.prototype.executeLimitForWhere_ = function() {
            var e = this;
            this.cursorOpenRequest.onsuccess = function(t) {
                (p = t.target.result) && e.results.length !== e.limitRecord && f() ? (e.results.push(p.value),
                p.continue()) : e.onQueryFinished()
            }
        }
        ,
        t.prototype.executeSimpleForWhere_ = function() {
            var e = this;
            this.cursorOpenRequest.onsuccess = function(t) {
                (p = t.target.result) ? (f() && e.results.push(p.value),
                p.continue()) : e.onQueryFinished()
            }
        }
        ,
        ...
        t.prototype.processGroupBy = function() {
            var e = this.query.groupBy
              , t = this.results
              , n = {};
            if (this.results = this.query.groupBy = void 0,
            Object(C.a)(e) === _.c.String)
                for (var r in t)
                    n[t[r][e]] = t[r];
            else {
                var o = void 0;
        ...
        t.prototype.executeAggregateGroupBy = function() {
            var e = this.query.groupBy
              , t = this.results;
            this.results = void 0;
            var n, r, o, i, u = {}, c = this.query.aggregate, s = function() {
                var e = function() {
                    return o = (o = u[r]) ? o["count(" + i + ")"] : 0,
                    o += t[n][i] ? 1 : 0
                }
                  , s = function() {
                    return o = (o = u[r]) ? o["max(" + i + ")"] : 0,
                    t[n][i] = t[n][i] ? t[n][i] : 0,
                    o > t[n][i] ? o : t[n][i]
                }
                  , a = function() {
                    return o = (o = u[r]) ? o["min(" + i + ")"] : 1 / 0,
                    t[n][i] = t[n][i] ? t[n][i] : 1 / 0,
                    o < t[n][i] ? o : t[n][i]
                }
                  , h = function() {
                    return o = (o = u[r]) ? o["sum(" + i + ")"] : 0,
                    o += t[n][i] ? t[n][i] : 0
                }
                  , l = function() {
            ...
            u)
                t.push(u[h]);
            if (c.avg)
                if (Object(C.a)(c.avg) === _.c.String)
                    for (n in t) {
                        var l = t[n]["sum(" + c.avg + ")"]
                          , f = t[n]["count(" + c.avg + ")"];
                        t[n]["avg(" + c.avg + ")"] = l / f,
                        c.count !== c.avg && delete t[n]["count(" + c.avg + ")"],
                        c.sum !== c.avg && delete t[n]["sum(" + c.avg + ")"]
                    }
                else {
                    ...
                    for (n in t)
                        for (var a in c.avg) {
                            var d = c.avg[a]
                              ...
                              , g = t[n]["count(" + d + ")"];
                            t[n]["avg(" + d + ")"] = b / g,
                            p && (c.count !== d ? delete t[n]["count(" + d + ")"] : -1 === c.count.indexOf(d) && delete t[n]["count(" + d + ")"]),
                            y && (c.sum !== d ? delete t[n]["sum(" + d + ")"] : -1 === c.sum.indexOf(d) && delete t[n]["sum(" + d + ")"])
                        }
                }
            this.results = t
        }
        ...
        t.prototype.orderBy = function(e) {
            ...
            if (null != n) {
                ...
                t = n.name,
                this.results.sort(function(e, n) {
                    return r(e[t], n[t])
                })
            }
        }
        ...
        t.prototype.processAggregateQry = function() {
            var e, t = this.results, n = t.length, r = {};
            this.results = void 0;
            var o = function() {
                var n = 0;
                for (var r in t)
        ...
        t.prototype.executeJoinQuery = function() {
            ...
            new M({
                ...
                t.forEach(function(t, n) {
                    var r;
                    e.results[n] = ((r = {})[e.currentQueryStackIndex_] = t,
                    r)
                }),
        ...
        t.prototype.onJoinQueryFinished_ = function() {
            ...
            if (null == this.error) {
                if (this.results.length > 0) {
                    ...
                    this.query[_.g.Skip] && this.query[_.g.Limit] ? (this.results.splice(0, this.query[_.g.Skip]),
                    this.results.splice(this.query[_.g.Limit] - 1, this.results.length)) : this.query[_.g.Skip] ? this.results.splice(0, this.query[_.g.Skip]) : this.query[_.g.Limit] && this.results.splice(this.query[_.g.Limit] - 1, this.results.length)
                }
        ...
        t.prototype.jointables = function(e, t, n) {
            var r, o, i, u = this, c = [], s = t.table1.column, a = t.table2.column, h = this.tablesFetched.indexOf(t.table1.table), l = this.currentQueryStackIndex_ + 1;
            switch (e) {
            case "left":
                i = 0,
        ...
        t.prototype.checkJoinQuery_ = function(e, t) {
            var n, r = e.table1, o = e.table2, i = this.getTable(r.table), u = this.getTable(o.table);
            t.with !== o.table && (n = new g.a(_.d.InvalidJoinQuery,"on value should contains value of with")),
            null == i.columns.find(function(e) {
            ...
            }) && (n = new g.a(_.d.InvalidJoinQuery,"column " + o.column + " does not exist in table " + o.table)),
            null == t.as && (t.as = {}),
            i.columns.every(function(e) {
                var i = u.columns.find(function(t) {
                    return t.name === e.name && t.name !== r.column
                });
                return null == i || null != t.as[i.name] || (n = new g.a(_.d.InvalidJoinQuery,"column " + e.name + " exist in both table " + r.table + " & " + o.table),
                !1)
            }),
    ...
    var F = function() {
      ...
      , M = function(e) {
        function t(t, n, r) {
            ...
            return o.onTransactionCompleted_ = function() {
                if (null == o.error)
                    ...
                    o.error)
                        ...
                        if (!0 === o.isOrderWithLimit && (o.results = o.results.slice(0, o.query.limit)),
                        o.query.distinct) {
                            var e = []
                              , t = o.results[0];
                            for (var n in t)
                            ...
                            var r = o.getPrimaryKey(o.query.from)
                              , i = e.indexOf(r);
                            e.splice(i, 1),
                            o.query.groupBy = e.length > 0 ? e : null
                        }
                        o.query.groupBy ? o.query.aggregate ? o.executeAggregateGroupBy() : o.processGroupBy() : o.query.aggregate && o.processAggregateQry(),
            ...
            o.tableName = t.from,
            t.order && (Object(Q.a)(t.order) && (t.order.idbSorting = !1),
            null != t.limit && (o.isOrderWithLimit = !0)),
            o
        }
        return F(t, e),
        t.prototype.execute = function() {
            ...
            null == e.error)
                try {
                    null == this.query.join ? null != this.query.where ? (this.initTransaction_(),
                    Object(Q.a)(this.query.where) ? this.processWhereArrayQry() : this.processWhere_()) : (this.initTransaction_(),
                    this.executeWhereUndefinedLogic()) : this.executeJoinQuery()
                } catch (e) {
                    this.onExceptionOccured(e)
                }
            else
        ...
        t.prototype.processWhereArrayQry = function() {
            var e = this;
            this.isArrayQry = !0;
            var t, n = this.query.where, r = this.getPrimaryKey(this.query.from), o = !0, i = [], u = function() {
                if (t === _.g.And) {
                    var u = function() {
                        var t = [];
                    ...
                    i.length > 0 ? (e.results = i.concat(e.results),
                    e.removeDuplicates(),
                    i = e.results) : i = e.results;
                o = !1,
                n.length > 0 ? (e.results = [],
                c()) : (e.results = i,
                !0 === e.isSubQuery && e.onTransactionCompleted_())
            }, c = function() {
                e.query.where = n.shift(),
                e.query.where[_.g.Or] && 1 === Object.keys(e.query.where).length ? (t = _.g.Or,
                e.query.where = e.query.where[_.g.Or],
                e.onWhereArrayQrySuccess = u) : (t = _.g.And,
                e.onWhereArrayQrySuccess = u),
                e.processWhere_()
            };
            c()
        }
        ...
        ,
        t.prototype.initTransaction_ = function() {
            this.createTransaction([this.tableName], this.onTransactionCompleted_, _.e.ReadOnly),
        ...
        t.prototype.orQuerySuccess_ = function() {
            if (this.orInfo.results = this.orInfo.results.concat(this.results),
            !this.query.limit || this.query.limit > this.orInfo.results.length) {
                this.results = [];
...
, function(e, t, n) {
    "use strict";
    var r, o = n(6), i = n(0), u = n(32), c = (r = function(e, t) {
        return (r = Object.setPrototypeOf || {
            __proto__: []
        }instanceof Array && function(e, t) {
            e.__proto__ = t
    ...
    function(e, t) {
        ...
        return h(t, e),
        t.prototype.executeWhereUndefinedLogic = function() {
            var e, t = this, n = this.objectStore.openCursor();
            n.onsuccess = function(n) {
                (e = n.target.result) ? (e.update(s(t.query.set, e.value)),
                ++t.rowAffected,
                e.continue()) : t.onQueryFinished()
            }
            ,
        ...
        return _(t, e),
        t.prototype.executeInLogic = function(e, t) {
            var n, r, o = this, i = this.objectStore.index(e);
            Object(p.a)(t.map(function(e) {
                return t = e,
                Object(f.a)(function(e, u) {
                    (r = i.openCursor(o.getKeyRange(t))).onsuccess = function(t) {
                        (n = t.target.result) ? (o.whereCheckerInstance.check(n.value) && (n.update(s(o.query.set, n.value)),
                        ++o.rowAffected),
                        n.continue()) : e()
                    }
                    ,
        ...
        t.prototype.executeRegexLogic = function(e, t) {
            ...
            o.onsuccess = function(e) {
                (n = e.target.result) ? (r.regexTest(n.key) && r.whereCheckerInstance.check(n.value) && (n.update(s(r.query.set, n.value)),
                ++r.rowAffected),
                n.continue()) : r.onQueryFinished()
            }
        }
        ,
        t
        ...
        t.prototype.executeWhereLogic = function(e, t, n) {
            ...
            (o = this.objectStore.index(e).openCursor(this.getKeyRange(t, n))).onsuccess = function(e) {
                (r = e.target.result) ? (i.whereCheckerInstance.check(r.value) && (r.update(s(i.query.set, r.value)),
                ++i.rowAffected),
                r.continue()) : i.onQueryFinished()
            }
            ,
            o.onerror = this.onErrorOccured
        }
      ...
      , w = function(e) {
        ...
        t.prototype.execute = function() {
            ...
            null == e.error)
                try {
                    this.initTransaction(),
                    null != this.query.where ? this.query.where.or || Object(D.a)(this.query.where) ? this.executeComplexLogic_() : this.goToWhereLogic() : this.executeWhereUndefinedLogic()
                } catch (e) {
                    this.onExceptionOccured(e)
                }
            else
        ...
        t.prototype.executeComplexLogic_ = function() {
            var e = this
              , t = new m.a({
                ...
                var n, r, o = e.getPrimaryKey(e.query.in), u = [];
                t.forEach(function(e) {
                    u.push(e[o])
                }),
                t = null;
                var c = ((n = {})[o] = ((r = {})[i.g.In] = u,
                r),
                n);
...
, function(e, t, n) {
    ...
    function(e, t) {
            ...
            Object(h.a)(t.map(function(t) {
                ...
                Object(a.a)(function(t, u) {
                    (r = o.objectStore.index(e).openCursor(o.getKeyRange(i))).onsuccess = function(e) {
                        (n = e.target.result) ? (o.whereCheckerInstance.check(n.value) && (n.delete(),
                        ++o.rowAffected),
                        n.continue()) : t()
                    }
                    ,
        ...
        t.prototype.executeRegexLogic = function(e, t) {
            ...
            o.onerror = this.onErrorOccured,
            o.onsuccess = function(e) {
                (n = e.target.result) ? (r.regexTest(n.key) && r.whereCheckerInstance.check(n.value) && (n.delete(),
                ++r.rowAffected),
                n.continue()) : r.onQueryFinished()
            }
        }
        ...
        t.prototype.executeWhereLogic = function(e, t, n) {
            ...
            t = n ? t[n] : t,
            (o = this.objectStore.index(e).openCursor(this.getKeyRange(t, n))).onsuccess = function(e) {
                (r = e.target.result) ? (i.whereCheckerInstance.check(r.value) && (r.delete(),
                ++i.rowAffected),
                r.continue()) : i.onQueryFinished()
            }
            ,
        ...
        ,
        t
    }(_), b = n(25), g = n(0), v = n(4), m = n(33), O = n(34);
    n.d(t, "a", function() {
        return x
    });
    var D = function() {
      ...
      , x = function(e) {
        ...
        t.prototype.execute = function() {
            ...
            null == e.error)
                try {
                    this.initTransaction_(),
                    null != this.query.where ? Object(m.a)(this.query.where) ? this.processWhereArrayQry() : this.processWhere_() : this.executeWhereUndefinedLogic()
                } catch (e) {
                    this.onExceptionOccured(e)
                }
            else
        ...
        t.prototype.processWhereArrayQry = function() {
            var e = this
              , t = new b.a(this.query,function(t) {
                var n, r, o = [], i = e.getPrimaryKey(e.query.from);
                t.forEach(function(e) {
                    o.push(e[i])
                }),
                t = null;
                var u = ((n = {})[i] = ((r = {})[g.g.In] = o,
                r),
                n);
                e.query.ignoreCase = null,
                e.query[g.g.Where] = u,
...
, function(e, t, n) {
    ...
    function(e, t) {
        ...
        t.prototype.executeWhereUndefinedLogic = function() {
            ...
            if (this.objectStore.count) {
                ...
                t.onsuccess = function() {
                    e.resultCount = t.result,
                    e.onQueryFinished()
                }
                ,
                t.onerror = this.onErrorOccured
            } else {
                var n, r = this.objectStore.openCursor();
                r.onsuccess = function(e) {
                    (n = e.target.result) ? (++this._resultCount,
                    n.continue()) : this.onQueryFinished()
                }
                .bind(this),
        ...
        return l(t, e),
        t.prototype.executeInLogic = function(e, t) {
            var n, r, o = this, i = this.objectStore.index(e), u = function(e) {
                return Object(a.a)(function(t, u) {
                    (r = i.openCursor(o.getKeyRange(e))).onsuccess = function(e) {
                        (n = e.target.result) ? (o.whereCheckerInstance.check(n.value) && ++o.resultCount,
                        n.continue()) : t()
                    }
                    ,
                    r.onerror = u
        ...
        t.prototype.executeRegexLogic = function(e, t) {
            ...
            o.onerror = this.onErrorOccured,
            o.onsuccess = function(e) {
                (n = e.target.result) ? (r.regexTest(n.key) && r.whereCheckerInstance.check(n.value) && ++r.resultCount,
                n.continue()) : r.onQueryFinished()
            }
        }
        ,
        ...
        t.prototype.executeWhereLogic = function(e, t, n) {
            var r, o, i = this;
            t = n ? t[n] : t,
            (this.objectStore.count ? function() {
            ...
            : function() {
                (r = i.objectStore.index(e).openCursor(i.getKeyRange(t, n))).onsuccess = function(e) {
                    (o = e.target.result) ? (i.whereCheckerInstance.check(o.value) && ++i.resultCount,
                    o.continue()) : i.onQueryFinished()
                }
            }
            )(),
            r.onerror = this.onErrorOccured
    ...
    var O = function() {
      ...
      , D = function(e) {
        ...
        t.prototype.execute = function() {
            ...
            null == t.error)
                try {
                    ...
                    null == this.query.join ? null != this.query.where ? this.query.where.or || Object(m.a)(this.query.where) ? n() : (this.initTransaction_(),
                    this.goToWhereLogic()) : (this.initTransaction_(),
                    this.executeWhereUndefinedLogic()) : n()
                } catch (e) {
                    this.onExceptionOccured(e)
                }
            else
        ...
        ,
        t.prototype.initTransaction_ = function() {
            this.createTransaction([this.query.from], this.onTransactionCompleted_, g.e.ReadOnly),
            this.objectStore = this.transaction.objectStore(this.query.from)
        }
        ,
        t
...
, function(module, __webpack_exports__, __webpack_require__) {
    ...
    function(e, t) {
    ...
    ), extendStatics, Instance = function(_super) {
        ...
        return __extends(Instance, _super),
        ...
        Instance.prototype.onRequestFinished_ = function(e) {
            var t = this.requestQueue.shift();
            t && (this.error ? (this.abortTransaction_("automatic abort of transaction due to error occured"),
            this.onErrorOccured(this.error)) : (this.isQueryExecuting = !1,
        ...
        Instance.prototype.executeRequest_ = function(e) {
            var t;
            switch (this.isQueryExecuting = !0,
            e.name) {
        ...
        Instance.prototype.pushRequest_ = function(e) {
            ...
            return !0 === this.isTxStarted_ ? this.checkQueries_([e]).then(function() {
                n(),
                t.processExecutionOfQry_()
            }).catch(function(e) {
                t.error = e,
                t.abortTransaction_(JSON.stringify(e))
            }) : n(),
            r
        }
        ,
