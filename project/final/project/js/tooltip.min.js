...
(function(a, b) {
    ...
    var c = function(a, b) {
      ...
      , f = {
        ...
        id: 'tooltip_' + Math.random().toString(36).substr(2, 10),
        candelete: true
    }
      , g = function() {
        function g(a, b) {
        ...
        return d(g, [{
            key: '_create',
            value: function(a, b, c, d, z) {
                var e = window.document.createElement('div');
                e.innerHTML = b.trim();
                var f = e.childNodes[0];
                f.setAttribute('id', 'tooltip_' + Math.random().toString(36).substr(2, 10));
                f.setAttribute('aria-hidden', 'false');
                f.setAttribute('candelete', z);
                this.options.id = f.getAttribute('id');
            ...
            value: function(b, c) {
                ...
                if (!d)
                    return this;
                var f = this._create(b, c.template, d, c.html, z);
